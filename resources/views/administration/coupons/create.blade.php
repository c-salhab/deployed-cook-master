<form class="w-1/2">
    ...
    <div class="my-3">
        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
            <input checked wire:model="duration_type" id="once" type="radio" value="once" name="duration-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="once" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Once</label>
        </div>
        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
            <input wire:model="duration_type" id="repeating" value="repeating" type="radio" value="" name="duration-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="repeating" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Repeating</label>
        </div>
        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
            <input wire:model="duration_type" id="forever" value="forever" type="radio" value="" name="duration-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
