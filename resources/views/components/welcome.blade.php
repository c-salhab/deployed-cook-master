...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900">
                <a href="{{route('lessons.shop')}}">Lessons</a>
            </h2>
        </div>
        ...
        <p class="mt-4 text-sm">
            <a href="{{route('lessons.shop')}}" class="inline-flex items-center font-semibold text-indigo-700">
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900">
                <a href="{{ route('courses.shop') }}">Certified courses</a>
            </h2>
        </div>
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            ...
            <a href="{{ route('courses.shop') }}" class="inline-flex items-center font-semibold text-indigo-700">
