<div>
    ...
    <div class="grid grid-cols-2 grid-flow-row gap-x-16">
        <div class="col-span-1 w-full max-w-lg">
            <div class="grid grid-cols-4 gap-x-1 gap-y-6">
                ...
                <div class="col-span-2 px-3">
                    ...
                    <input wire:model="price" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="10">
                ...
                <div class="col-span-2 px-3">
                    ...
                    <div class="relative">
                        <select wire:model="currency" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            <option>eur</option>
                            <option>usd</option>
                        </select>
                    </div>
                ...
                <div class="col-span-2 px-3">
                    ...
                    <input wire:model="advantage" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="Unlimited pasta">
                </div>
