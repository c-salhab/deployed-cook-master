<x-management-layout>
            ...
            <form method="POST" action="{{ route('management.events.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input id="max_capacity" name="max_capacity" type="number" class="block w-full bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        @error('max_capacity')
                        <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <script>
        var input = document.getElementById("max_capacity");
