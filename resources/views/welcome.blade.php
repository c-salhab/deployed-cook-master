<x-guest-layout>
            ...
            <div class="flex flex-wrap items-center sm:-mx-3">
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-4 sm:max-w-md lg:max-w-lg lg:space-y-4 lg:pr-0 md:pb-0">
                      ...
                      > -->
                        <h3 class="text-xl"><i>OUR STORY</i>
                        </h3>
    ...
    <section class="pt-4 pb-12 bg-gray-50">
        <div class="my-8 text-center">
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                Food Gallery</h2>
            <p class="text-xl"> A Visual Feast for the Senses</p>
        </div>
    ...
    <section class="pt-12 pb-12 bg-red-50">
        <div class="container flex items-center justify-center p-6 mx-auto bg-white shadow-lg sm:p-12 md:w-1/2 contact">
            <div class="w-full">
...
{{--                <form method="POST" action="{{ route('contact.submit') }}">--}}
                    ...
                    <div class="">
                        ...
                        <textarea name="" id="" rows="8" cols="30" name="content"
